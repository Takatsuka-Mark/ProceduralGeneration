...
namespace defaultNamespace
{
    public class SimplexNoise
    {
        ...
        public double generateNoise(Vector3 vertex)
        {
            ...
            int i1, j1, k1 = 0;    // offsets for 2nd corner of simplex in (i, j, k) coords
            int i2, j2, k2 = 0;    // offsets for 3rd corner of simplex
            ...
            double y1 = y0 - j1 + G3;
            double z1 = z0 - k1 + G3;
            double x2 = x0 - i2 + 2.0 * G3;    // offsets for 3rd corner
            ...
            double t0 = 0.5 - x0 * x0 - y0 * y0 - z0 * z0;    // TODO check to see if 0.6 generates worse results
            ...
            {
                t1 *= t0;
                n1= t1 * t1 * dot(_grad[gi0], x1, y1, z1);
            }
            ...
            {
                t2 *= t0;
                n2 = t2 * t2 * dot(_grad[gi0], x2, y2, z2);
            }
            ...
            {
                t3 *= t0;
                n3 = t3 * t3 * dot(_grad[gi0], x3, y3, z3);
            }
